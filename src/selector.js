import { PanelBody, PanelRow, SelectControl, Panel } from "@wordpress/components";
                ...
                <Panel header="HPU Blocks Paragraph Settings" className='hpu-blocks-emphasis-style'>
                    <SelectControl
                        ...
                        options={[
                            ...
                            { label: "Primary", value: "hpu-blocks-primary-style" },
                            { label: "Secondary", value: "hpu-blocks-secondary-style" },
                            { label: "Muted", value: "hpu-blocks-muted-style" },
                            { label: "Emphasis", value: "hpu-blocks-emphasis-style" },
                        ]}
